...
<head>
    ...
    <link rel="shortcut icon" href="imagens/P16x16.ico" type="image/x-icon" />
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block text-dark">
                            ...
                            <p class="lead" id="p-carousel">Está com dificuldades em um projeto? Busque profissionais para contratar e então finalizá-lo!</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block text-dark">
                            <h1>Busque novos contatos profissionais!</h1>
                            <p class="lead" id="p-carousel">Conheça trabalhos e pessoas de sua área e aumente sua rede de contatos!</p>
                        </div>
                    </div>
                </div>
                <!--    Fim dos itens  -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center my-1">
                        <h1 class="display-3">InProjects</h1>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-sm-6 col-md-9" style="background-color: #f8f8f8; max-height: 330px">
                        ...
                        <div data-spy="scroll" data-target="#navbarVertical" data-offset="0" class="scrolspySite mt-2">
                            ...
                            <p>Dúvidas? Nos contacte! vtr.fariasqi@gmail.com / mcmatheuskx@gmail.com</p>
