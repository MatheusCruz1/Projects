...
<body>
    ...
    <div class="container">
        ...
        <div class="btn-group mt-3" role="group" aria-label="Basic example" style="width: 100%">
            <button type="button active" class="btn" onclick="location.href='pesquisarProjetoOff.php'" id="item-menu-projetos-active" style="width: 50%">Pesquisar Projetos</button>
            <button type="button" class="btn" onclick="location.href='pesquisarUsuarioOff.php'" id="item-menu-projetos" style="width: 50%">Pesquisar Usuários</button>
        </div>
