...
<head>
    ...
    <title>Projeto de outros proprietarios</title>
</head>
                            ...
                            <table class="table table-striped table-hover table-bordered" id="myTable">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT projeto.id, projeto.nome_projeto, statusProjeto.nome, projeto.statusProjeto_id, projeto.numero_atual_participantes, projeto.numero_max_participantes, projeto.data_inicio FROM (((statusProjeto INNER JOIN projeto ON statusProjeto.id = projeto.statusProjeto_id) INNER JOIN usuario_projeto ON projeto.id = usuario_projeto.projeto_id) INNER JOIN usuario ON usuario.id = usuario_projeto.usuario_id) WHERE usuario_projeto.usuario_id = '$idUser' && usuario_projeto.tipo_id != 1;";
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <?php
                                                ...
                                                $sql2 = "SELECT usuario.nome_usuario FROM ((usuario INNER JOIN usuario_projeto ON usuario.id = usuario_projeto.usuario_id) INNER JOIN projeto ON projeto.id = usuario_projeto.projeto_id) WHERE usuario_projeto.tipo_id = 1 && projeto.id = '$idPro'";

                                                $result2 = mysqli_query($conexao, $sql2) or die( mysqli_error($conexao));
                                                $aux2 = mysqli_fetch_assoc($result2);

                                                echo $aux2["nome_usuario"];
                                            ?>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="cadastrar/sairPro.php?x=<?php echo $IdPro64 ?>&&y=<?php echo $idUser64 ?>" title="Sair do projeto" data-toggle="tooltip" style="background: none;">
